...
def create_google_maps_url(gps_coords):            
    ...
    # We return a search string which can be used in Google Maps
        try:
            ...
            return "Invalid GPS data: division by zero encountered in coordinates."
        except Exception as e:
            return f"Invalid GPS data: {e}"
...
# Print Logo
print("""
   _____         _____ _  __       _______   ________   _______ ______ 
  / ____|  /\   |_   _| |/ /    /\|__   __| |  ____\ \ / /_   _|  ____|
 | (___   /  \    | | | ' /    /  \  | |    | |__   \ V /  | | | |__   
  \___ \ / /\ \   | | |  <    / /\ \ | |    |  __|   > <   | | |  __|  
  ____) / ____ \ _| |_| . \  / ____ \| |    | |____ / . \ _| |_| |     
 |_____/_/    \_\_____|_|\_\/_/    \_\_|    |______/_/ \_\_____|_|     
