// 🧩 Problem: Design a Movie Renting System

// You have n shops numbered from 0 to n - 1 that rent movies. Each shop carries certain movies at different prices. You are given an array entries where each element is of the form [shop, movie, price], indicating that the shop shop rents the movie movie for the given price.

// Implement the MovieRentingSystem class that supports the following operations:
